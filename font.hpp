...
// Klasický 8x8 Bitmapový font (ASCII znaky 32 až 127)
// Každý znak má 8 řádků, každý řádek je 1 byte (8 pixelů)
const uint8_t font8x8[96][8] = {
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 32: Mezera
    ...
    {0x3C,0x66,0x06,0x18,0x18,0x00,0x18,0x00}, // 63: ?
    ...
    {0xFE,0x60,0x60,0x7C,0x60,0x60,0xFE,0x00}, // 69: E
    {0xFE,0x60,0x60,0x7C,0x60,0x60,0x60,0x00}, // 70: F
    ...
    {0xFC,0x66,0x66,0x7C,0x60,0x60,0x60,0x00}, // 80: P
    {0x38,0x6C,0xC6,0xC6,0xDA,0xCC,0x76,0x00}, // 81: Q
    {0xFC,0x66,0x66,0x7C,0x6C,0x66,0xC6,0x00}, // 82: R
    ...
    {0x80,0xC0,0x60,0x30,0x18,0x0C,0x06,0x00}, // 92: Zpetne lomitko
